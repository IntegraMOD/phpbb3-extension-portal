...
$template->assign_vars([
	'TOP_TOPICS_DAYS'   => sprintf(isset($user->lang['TOP_TOPICS_DAYS']) ? $user->lang['TOP_TOPICS_DAYS'] : '%d', isset($k_config['k_top_topics_days']) ? $k_config['k_top_topics_days'] : 0),
	'TOP_TOPICS_DEBUG'  => sprintf(isset($user->lang['PORTAL_DEBUG_QUERIES']) ? $user->lang['PORTAL_DEBUG_QUERIES'] : '%d - %d - %d', (isset($queries) ? $queries : 0), (isset($cached_queries) ? $cached_queries : 0), (isset($total_queries) ? $total_queries : 0)),
]);
